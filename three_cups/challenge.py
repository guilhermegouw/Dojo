...
There is a ball under the cup at the left. It’s our job to keep track of the
location of the ball as Borko swaps the locations of the cups.
...
For example: 
If Borko’s ﬁrst swap is type A, then he swaps the left and middle cups;
